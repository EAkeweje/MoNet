...
import torch_geometric.nn #import (graclus, max_pool, global_mean_pool)
...
class MoNet(torch.nn.Module):
    def __init__(self, kernel_size):
        ...
        self.conv1 = torch_geometric.nn.GMMConv(1, 32, dim=2, kernel_size=kernel_size)
        self.conv2 = torch_geometric.nn.GMMConv(32, 64, dim=2, kernel_size=kernel_size)
        self.conv3 = torch_geometric.nn.GMMConv(64, 64, dim=2, kernel_size=kernel_size)
    ...
    def forward(self, data):
        ...
        data.edge_attr = None
        data = torch_geometric.nn.max_pool(cluster, data, transform=T.Cartesian(cat=False))
